            ...
            <AnimatedText delay={0.6}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/works">
                  <Button
                    size="lg"
                    className="group glass-card hover:bg-foreground hover:text-background transition-all duration-300"
                  >
                    View My Work
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                {
                  value: profile?.stats?.yearsExperience || 8,
                  label: "Years Experience",
                },
                {
                  value: profile?.stats?.projectsCompleted || 150,
                  label: "Projects Completed",
                },
                {
                  value: profile?.stats?.happyClients || 80,
                  label: "Happy Clients",
                },
            ...
            <AnimatedText delay={0.5} className="text-center mt-12">
              <Link to="/works">
                <Button
                  variant="outline"
                  size="lg"
                  className="group border-foreground/30 hover:border-foreground/60"
                >
                  View All Works
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Button>
        ...
        <footer className="py-8 border-t border-border/30">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <span className="font-display font-bold text-lg">Zion</span>
              <p className="text-sm text-muted-foreground">
                © {new Date().getFullYear()} Tsion Tilahun. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
